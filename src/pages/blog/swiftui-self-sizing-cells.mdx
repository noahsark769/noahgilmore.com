...
<CaptionedImage filename="swiftuicell-1.png" max={300} caption="If you want to build these cells in SwiftUI, this post is for you" alt="Screenshot of SwiftUI table view cells displayed in the sample app." />
