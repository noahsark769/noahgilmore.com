...
# Conclusion
Hopefully this was a helpful look into the world of `preferredContentSize`, view controller wrapping, and UIKit popovers. Though this solution takes some time to explain, I think it ends up being pretty clean:
