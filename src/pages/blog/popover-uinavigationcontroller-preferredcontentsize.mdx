...
# Conclusion
Hopefully this was a helpful look into the world of `preferredContentSize`, view controller wrapping, and UIKit popovers. Though this solution takes some time to explain, it has a few advantages which I really like:
...
3. No need to set `preferredContentSize` unecessarily

With more plumbing, it's possible to implement the same interaction without having to call into `self.popoverPresentationController` - you can have a 