...
Turns out, [WebP](https://developers.google.com/speed/webp), the web-optimized image format developed by Google, isn't supported natively by UIKit, but it's not too hard to implement support for it with the help of a small library and some deeper UIKit APIs.
