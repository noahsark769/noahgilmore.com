...
2. Since there's no ad network, there's no ad targeting. There's no Facebook bloat targeting you, and the site is [open source](https://github.com/noahsark769/noahgilmore.com). I use Google Analytics to track clicks on sponsored links so that I can make sure my analytics line up with those of the advertisers, but that's the extent of the data I'm tracking.
