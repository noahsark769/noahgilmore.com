...
const Nav = (props) => {
    ...
    return (
        <StyledNav>
            ...
            <NavLinks>
                { props.blog && <NavLink title="Site Home"><StyledA aria-label="Home" href="/"><IoIosHome color={blue} size="24" /></StyledA></NavLink> }
                { !props.blog && <NavLink title="Blog"><StyledA aria-label="Blog" href="/blog"><ImBlog color={blue} size="24" /></StyledA></NavLink> }
