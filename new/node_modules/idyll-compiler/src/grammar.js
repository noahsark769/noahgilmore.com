...
var grammar = {
    ...
    {"name": "TextInline$subexpression$1", "symbols": ["BoldEmInline"]},
    ...
    {"name": "BoldEmInline$string$1", "symbols": [{"literal":"S"}, {"literal":"T"}, {"literal":"R"}, {"literal":"O"}, {"literal":"N"}, {"literal":"G"}, {"literal":"E"}, {"literal":"M"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "BoldEmInline", "symbols": ["BoldEmInline$string$1", "__", "TokenValue"], "postprocess": 
        function(data, location, reject) {
