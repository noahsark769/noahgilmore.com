...
exports.default = {
  ...
  getDomainWithZero: function (props, axis) {
    ...
    var ensureZero = function (domain, dataset) {
      ...
      var min = _collection2.default.getMinValue([].concat(_toConsumableArray(domain), _toConsumableArray(minData)));
      var max = _collection2.default.getMaxValue([].concat(_toConsumableArray(domain), _toConsumableArray(maxData)));
      return [min, max];
    };
    var categoryDomain = this.getDomainFromCategories(props, axis);
    if (categoryDomain) {
