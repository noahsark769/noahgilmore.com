...
## Conclusion
Hopefully this post helps some folks understand an unnecessarily frustrating UIKit API. If you're looking for a truly customizable `UIButton`, don't forget that you can subclass `UIControl` directly and use your own layout entirely (I did this for [Trestle](https://itunes.apple.com/us/app/trestle-the-new-sudoku/id1300230302?mt=8) and it worked well for when I needed SVGs (!) inside the button).
