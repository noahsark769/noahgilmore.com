...
3. If you use an ad blocker that supports blocking elements on the page by class name, you can opt out of ads entirely by blocking elements with the class name `sponsorship-opt-out-point`. For Adblock Plus, for example, the rule looks like `noahgilmore.com##.sponsorship-opt-out-point`. For sidebar content, you can also click the "hide" button to block the ad.
