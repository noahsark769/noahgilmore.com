...
Once we've got this working, it's easy enough to take some data, base64 encode it, and copy it to the clipboard in addition to the link's url parameter. I'm using React here, but other frameworks or vanilla JS should be similar:
