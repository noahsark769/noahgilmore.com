...
<CaptionedImage max={500} filename="popover-animation-3.gif" alt="Red view controller transitioning to green view controller with size animating at the same time as the push animation." caption="🎉" />

## Updating the size
TODO this section is about how to animate the content size without push, but it only works outwardly (i.e. setPreferredContentSizeFromAutolayout)
