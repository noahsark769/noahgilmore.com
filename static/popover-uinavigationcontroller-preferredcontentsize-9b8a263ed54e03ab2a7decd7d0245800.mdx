...
We also need the implementation of `UINNavigationControllerDelegate` to respond to when the navigation controller is about to show a new view controller:
