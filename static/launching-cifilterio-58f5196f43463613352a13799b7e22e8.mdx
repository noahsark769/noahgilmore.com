...
<CaptionedImage max="300" filename="cicomiceffect.gif" alt="Gif showing CICheckerboardGenerator in the CIFilter.io app" caption="The color wheels don't transfer very well to GIFs" />
