...
<CaptionedImage filename="cisourceoutcompositing.png" alt="Example of applying the CISourceOutCompositing filter" caption="The color wheels don't transfer very well to GIFs" />
...
<CaptionedImage max="300" filename="cicheckerboardgenerator.gif" alt="Gif showing CICheckerboardGenerator in the CIFilter.io app" caption="" />
