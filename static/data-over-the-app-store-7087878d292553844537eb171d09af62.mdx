...
# Conclusion
Hopefully this was an interesting technical discussion of a way to provide user delight in the flow from mobile web to app. If you're wondering about anything or have any other hacky ideas about how to pass data across the app store, feel free to [reach out](https://twitter.com/noahsark769).