...
> Note: we need a `CAMetalLayer` instead of an [`MTKView`](https://developer.apple.com/documentation/metalkit/mtkview) here, for reasons I'll get into at the end of this post.
