...
From the app side, [UIPasteboard](https://developer.apple.com/documentation/uikit/uipasteboard) is a UIKit class which allows your app to integrate with iOS's copy and paste functionality. If you've ever seen a "copy link" button in an app, it's probably using `UIPasteboard`.
