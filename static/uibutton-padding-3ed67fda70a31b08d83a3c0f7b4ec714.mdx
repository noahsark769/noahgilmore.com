...
2. Add 10pt to the left edge of the `titleEdgeInsets` to shift the button over
3. Add 10pt to the *right* edge of the `titleEdgeInsets` since we have to make sure the button doesn't get cut off by ellipsis
...
<CaptionedImage max={200} filename="uibutton-wireframe.png" alt="Wireframe explaining the incantation required to add padding between the image and title of a UIButton" caption="Magic incantation" />
