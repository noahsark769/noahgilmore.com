...
2. When the navigation controller is about to show a new view controller, we'll set the wrapper view controller's `preferredContent` to be the child's content size.
