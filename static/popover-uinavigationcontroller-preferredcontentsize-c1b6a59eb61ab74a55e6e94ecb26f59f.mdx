...
<CaptionedImage max={400} filename="red-controller-1.png" alt="Red view controller displaying in a popover with the wrong height and width" caption="Interesting" />
