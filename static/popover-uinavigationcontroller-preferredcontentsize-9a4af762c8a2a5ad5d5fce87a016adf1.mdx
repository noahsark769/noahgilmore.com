...
The question is how to get access to the `PopoverPushController`, and the answer is simple: it's the `presentedViewController` of our `popoverPresentationController`! All we have to do is update it when our size changes:
