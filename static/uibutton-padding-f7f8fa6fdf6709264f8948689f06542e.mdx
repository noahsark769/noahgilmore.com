...
<CaptionedImage max={300} filename="uibutton-final.png" alt="Wireframe explaining the incantation required to add padding between the image and title of a UIButton" caption="Magic incantation" />
