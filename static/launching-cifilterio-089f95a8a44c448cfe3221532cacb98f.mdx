...
For the filters which are listed, many have incomplete documentation: for example, the `inputSharpness` paramter to [CICheckerboardGenerator](https://cifilter.io#CICheckerboardGenerator) says:
