...
- `xcrun altool --notarization-info UUID -u "EMAIL" -p APP_SPECIFIC_PW`
...
Gotta add the timestamp to other code sign flags for Sparkle in post_install maybe?

https://github.com/sparkle-project/Sparkle/issues/1550
